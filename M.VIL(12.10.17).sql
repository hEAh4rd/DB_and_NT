...
--
-- Name: hierarchy; Type: TYPE; Schema: public; Owner: postgres
--
...
CREATE TABLE seasons (
    id integer NOT NULL,
    number_of_season text NOT NULL,
...
COPY characters_in_packs ("character", pack) FROM stdin;
1	1
1	9
2	1
2	6
...
SELECT pg_catalog.setval('packs_alpha_seq', 1, false);
...
SELECT pg_catalog.setval('packs_id_seq', 16, true);
